...
class Config(object):
    ...
    OWNER_ID = int(getenv("OWNER_ID", 1754029718))
    OWNER_USERNAME = getenv("OWNER_USERNAME", "ZERGIIORVDRA")
    SUPPORT_CHAT = getenv("SUPPORT_CHAT", "MUTUALAN_CARI_TEMAN_VIRTUAL")
    LOGGER_ID = int(getenv("LOGGER_ID", "-1001624342603"))
    MONGO_URI = getenv(
        "MONGO_DB_URI",
